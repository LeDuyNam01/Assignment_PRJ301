    ...
    <div class="container my-5">
        ...
        <div style="padding-left: 50px">
            ...
            <div class="single_product_desc">
                ...
                <!-- Add to Cart Form -->
                <c:if test="${product.quantity > 0}">
                <a href="<c:if test="${user==null}">
                                                   login
                                               </c:if>
                                               <c:if test="${user!=null}">home?id_product=${product.id} </c:if>"><button type="button" name="addtocart" value="${product.id}" class="btn btn-primary">Add to cart</button></a>
            </c:if>
                </div>
        </div>
    </div>
